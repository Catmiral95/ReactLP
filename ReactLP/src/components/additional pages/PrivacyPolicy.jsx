    ...
    <>
      ...
      <div className="mainText col">
        ...
        <p>
          ...
          которую ИП Артемьев Артём Сергеевич ИНН 210802556940 (далее —
          Компания), Сайт которого размещён в сети Интернет по адресу:
          www.lider-prava.ru (далее — Сайт), может получить о Пользователе во
          время использования Сайта, его сервисов, программ и продуктов.
          <br />
          <br />
        ...
        <p>
          ...
          <br />
          1.1.6. Cookies — небольшой фрагмент данных, отправленный веб-сервером
          и хранимый на компьютере пользователя, который веб-клиент или
          веб-браузер каждый раз пересылает веб-серверу в HTTP(S)-запросе при
        ...
        <p>
          ...
          платежей, используемые браузеры и операционные системы и т.д.)
          подлежит надежному хранению и нераспространению, за исключением
          случаев, предусмотренных в п.п. 4.2. и 4.3. настоящей Политики
          конфиденциальности.
        </p>
        ...
        <p>
          ...
          <br />
          3.1.8. Предоставления Пользователю эффективной клиентской и
        ...
        <p>
          ...
          исключительно в целях выполнения заключенных с Пользователем
          договоров.
          <br />
        ...
        <p>
          ...
          Пользователя, за исключением п.п. 4.2. и 4.3. настоящей Политики
          Конфиденциальности.
          <br />
