...
export default function ConsentText({ windowWidth }) {
  return (
    <>
      ...
      <div className="mainText col">
        ...
        <p>
          ...
          <br />
          — создания учетной записи для совершения платежей, если Пользователь
          ...
          физическому лицу (субъекту персональных данных – Пользователь) и
          ...
          относящаяся к прямо или косвенно определенному или определяемому
          физическому лицу (субъекту персональных данных – Пользователь) и
          включают в себя следующую информацию: Компания обязуется не передавать
          полученные персональные данные третьим лицам, за исключением следующих
          ...
          Изменения условий настоящих правил вступают в силу после их публикации
          на Сайте.
          <br />
          <br />
